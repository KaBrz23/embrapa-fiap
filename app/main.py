...
# Configuração CORS - ajuste os origins conforme seu frontend (ex: localhost:3000)
origins = [
    "http://localhost",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    # Adicione outras URLs do frontend que você usar
]

app.add_middleware(
    CORSMiddleware,
    allow_origins=origins,    # para liberar tudo use ["*"]
